		...
		<div class="container mt-5">
			...
			<form action="quoteStatus" method="post">
				...
				<fieldset class="row mb-4">
					...
					<div class="col-sm-10">
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="quoteType"
								value="내역"> <label class="form-check-label">내역</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="quoteType"
								value="집계"> <label class="form-check-label">집계</label>
						</div>
						<select class="form-select my-2" name="quoteTypeDropDown"
						...
						</select> <span class="badge text-bg-secondary">비교기간</span>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="quoteType"
								value="사용안함"> <label class="form-check-label">사용안함</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="quoteType"
								value="전년동일기간"> <label class="form-check-label">전년동일기간</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="quoteType"
								value="전월동일기간"> <label class="form-check-label">전월동일기간</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="quoteType"
								value="전주동일기간"> <label class="form-check-label">전주동일기간</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="quoteType"
								value="전일동일기간"> <label class="form-check-label">전일동일기간</label>
						</div>
					</div>
				</fieldset>
				...
				<fieldset class="row mb-4">
					...
					<div class="col-sm-10">
						<div class="input-group">
							<input class="form-control" type="text" name="Customers"
								placeholder="거래처">
							<button class="btn btn-outline-secondary" type="submit">
								<i class="fa-solid fa-magnifying-glass"></i>
							</button>
				...
				<fieldset class="row mb-4">
					...
					<div class="col-sm-10">
						<div class="input-group">
							<input class="form-control" type="text" name="PICforCustomer"
				...
				<fieldset class="row mb-4">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="NewItem"
							placeholder="새로운 항목 추가" required>
					</div>
				</fieldset>
					...
					<div class="col-sm-10">
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="checkbox"
								name="quotePS_All" value="전체"> <label
								class="form-check-label">전체</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="checkbox"
								name="quotePS_e-Approval" value="결재중"> <label
								class="form-check-label">결재중</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="checkbox"
								name="quotePS_Unconfirmed" value="미확인"> <label
								class="form-check-label">미확인</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="checkbox"
								name="quotePS_Confirmed" value="확인"> <label
								class="form-check-label">확인</label>
						</div>
						<div class="input-group mt-2">
							<span class="badge text-bg-secondary me-2">확인-진행상태</span> <input
								class="form-control" type="text" name="Confirm-PS"
								placeholder="확인-진행상태">
							<button class="btn btn-outline-secondary" type="submit">
								<i class="fa-solid fa-magnifying-glass"></i>
							</button>
				...
				<fieldset class="row mb-4">
					...
					<div class="col-sm-10">
						<div class="input-group">
							<input class="form-control" type="text" name="LastModifier"
								placeholder="최종수정자">
							<button class="btn btn-outline-secondary" type="submit">
								<i class="fa-solid fa-magnifying-glass"></i>
							</button>
