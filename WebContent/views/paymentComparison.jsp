        ...
        <div class="container mt-5">
            ...
            <form action="quoteStatus" method="post">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <button type="submit" class="btn btn-light">금일</button>
                    <button type="submit" class="btn btn-light">전일</button>
                    <button type="submit" class="btn btn-light">금주(~오늘)</button>
                    <button type="submit" class="btn btn-light">전주</button>
                    <button type="submit" class="btn btn-light">다시 작성</button>
                </div>
            </form>
        </div>
